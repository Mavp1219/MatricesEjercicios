...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 20, 300, 40));
    ...
    private void cmdCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdCrearActionPerformed
        try {
            ...
            if (txtNumerocolumnas.getText().trim().isEmpty()) {
                ...
                if (nf >= 13 && nc >= 13) {
                    JOptionPane.showMessageDialog(this, "La matriz se pasa de lo establecido", "Error", JOptionPane.ERROR_MESSAGE);
